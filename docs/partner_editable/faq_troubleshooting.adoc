...
*Q.* Does this quickstart install {partner-product-name} networking for Kubernetes pods as well as network policy?

*A.* This quickstart currently installs {partner-product-name} for policy only, with networking provided by the Amazon VPC CNI plugin.
