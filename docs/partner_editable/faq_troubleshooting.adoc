...
*Q.* Does this quickstart install Calico networking for Kubernetes pods as well as network policy?

*A.* This quickstart currently installs Calico for policy only, with networking provided by the Amazon VPC CNI plugin.
